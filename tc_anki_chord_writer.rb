...
class TestAnkiChordWriter < Test::Unit::TestCase
  ...
  def test_answer
    assert_equal("<img src=\"pianochord_Es_maj7_1.png\">",AnkiChordWriter.new(Chord.new("Es",:maj7,:root)).answer)
    assert_equal("<img src=\"pianochord_Ais_min7_1.png\">",AnkiChordWriter.new(Chord.new("Ais",:minor7,:root)).answer)
